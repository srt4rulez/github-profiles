...
export type GetUserProfileDetailsQueryVariables = Exact<{
  login: Scalars['String'];
}>;


export type GetUserProfileDetailsQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, login: string, name?: string | null, bio?: string | null, url: string, avatarUrl: string, createdAt: string, issues: { __typename?: 'IssueConnection', totalCount: number }, followers: { __typename?: 'FollowerConnection', totalCount: number }, repositories: { __typename?: 'RepositoryConnection', totalCount: number, nodes?: Array<{ __typename?: 'Repository', id: string, name: string, description?: string | null, url: string, stargazerCount: number, updatedAt: string } | null> | null }, topRepositories: { __typename?: 'RepositoryConnection', totalCount: number, nodes?: Array<{ __typename?: 'Repository', id: string, name: string, description?: string | null, url: string, stargazerCount: number, updatedAt: string } | null> | null } } | null };
...
export type SearchUserQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', nodes?: Array<{ __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository' } | { __typename?: 'User', id: string, login: string, name?: string | null, avatarUrl: string } | null> | null } };
...
export const GetUserProfileDetailsDocument = gql`
  ...
  user(login: $login) {
    ...
    topRepositories(first: 4, orderBy: {direction: DESC, field: STARGAZERS}) {
      totalCount
      nodes {
        id
        name
...
/**
 * __useGetUserProfileDetailsQuery__
 *
 * To run a query within a React component, call `useGetUserProfileDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUserProfileDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserProfileDetailsQuery({
 *   variables: {
 *      login: // value for 'login'
 *   },
 * });
 */
export function useGetUserProfileDetailsQuery(baseOptions: Apollo.QueryHookOptions<GetUserProfileDetailsQuery, GetUserProfileDetailsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserProfileDetailsQuery, GetUserProfileDetailsQueryVariables>(GetUserProfileDetailsDocument, options);
      }
export function useGetUserProfileDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserProfileDetailsQuery, GetUserProfileDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserProfileDetailsQuery, GetUserProfileDetailsQueryVariables>(GetUserProfileDetailsDocument, options);
        }
export type GetUserProfileDetailsQueryHookResult = ReturnType<typeof useGetUserProfileDetailsQuery>;
export type GetUserProfileDetailsLazyQueryHookResult = ReturnType<typeof useGetUserProfileDetailsLazyQuery>;
export type GetUserProfileDetailsQueryResult = Apollo.QueryResult<GetUserProfileDetailsQuery, GetUserProfileDetailsQueryVariables>;
